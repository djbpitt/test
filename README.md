...
![exist-db CI](https://github.com/djbpitt/test/workflows/exist-db%20CI/badge.svg)

<img src="icon.png" align="left" width="25%"/>

My amazing test application
...
1.  Download  the `test-1.0.0.xar` file from GitHub [releases](https://github.com/djbpitt/test/releases) page.

2.  Open the [dashboard](http://localhost:8080/exist/apps/dashboard/index.html) of your eXist-db instance and click on `package manager`.

    1.  Click on the `add package` symbol in the upper left corner and select the `.xar` file you just downloaded.

3.  You have successfully installed test into exist.
...
If you see `BUILD SUCCESSFUL` ant has generated a `test-1.0.0.xar` file in the `build/` folder. To install it, follow the instructions [above](#installation).
...
MIT © [gab_keane](https://gabikeane.github.io/portfolio)

[license-img]: https://img.shields.io/badge/license-MIT-blue.svg
[license-url]: https://opensource.org/licenses/MIT
[release-img]: https://img.shields.io/badge/release-1.0.0-green.svg
[release-url]: https://github.com/djbpitt/test/releases/latest
